...
public class dialogSetor extends javax.swing.JDialog {
    ...
    private daoSetor dao = new daoSetor();
    
    private void carregaTable(){
        tabela.setModel(new MyTableModel(Setor.class, dao.read(), tabela));
    }
    
    private void carregaTableNome(String filtro){
        tabela.setModel(new MyTableModel(Setor.class, dao.readByNome(filtro), tabela));
    }
    ...
    private Setor retornaObjeto(){
        ...
        s.setLocalizacao(textLocalizacao.getText());
        return (s);
    }
    
    private void populaComponentes(Setor s){
        textId.setText(s.getId()+"");
        textNome.setText(s.getNome());
        textLocalizacao.setText(s.getLocalizacao());
    }
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(textNome, javax.swing.GroupLayout.DEFAULT_SIZE, 163, Short.MAX_VALUE)
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(textFiltro, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void buttonApagarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonApagarActionPerformed
        ...
        try{
            ...
            dao.delete(dao.read(Setor.class, codigo));
            this.limpaComponentes();
            buttonFiltrar.doClick();
            painel.setSelectedIndex(1);
        }catch(Exception ex){
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        if (evt.getClickCount()==2){
            ...
            this.populaComponentes(dao.read(Setor.class, codigo));
            painel.setSelectedIndex(0);
        }
